module.exports = function create(stream, bunyan, appName, config) {
  if(config.enabled === false) {
    return createStub();
  }

  let options = createOptions(bunyan, stream, appName, config);
...
function createOptions(env, name, stream, config){
